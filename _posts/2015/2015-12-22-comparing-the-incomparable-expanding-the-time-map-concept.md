...
tags: 
  ...
  - "time-maps"
  - "time-series"
coverImage: "/assets/images/2015/12/timemaps_fig09.png"
---
...
![timemaps_fig01](/assets/images/2015/12/timemaps_fig01.png)
...
In this news site, most of the events occurred at one-minute intervals. The typical service break in this site is either one or two days long, as represented by the two distinct strips. Using the time map approach is relatively easy to identify bots. For example, the owners of the following site have uploaded more than 1,000 posts such that most of them were published at a one-minute interval — a pattern that is unlikely to be performed by a human.

![timemaps_fig05](/assets/images/2015/12/timemaps_fig05.png)
...
![timemaps_fig09](/assets/images/2015/12/timemaps_fig09.png)

Let us now examine the normalised time maps of the two users mentioned above:

![timemaps_fig10](/assets/images/2015/12/timemaps_fig10.png)
...
![timemaps_fig11](/assets/images/2015/12/timemaps_fig11.png)
...
![timemaps_fig12](/assets/images/2015/12/timemaps_fig12.png)
