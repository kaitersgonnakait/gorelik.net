...
![Example of a bad chart. I have no idea what it means](/assets/img/2017/12/01_wtf_is_this.png){:width="300"}
...
![Two more bad charts. The graphs are meaningless!](/assets/img/2017/12/02_another_wtf.png){:width="286"}
...
![Not an ideal pie chart but at least we can understand it](/assets/img/2017/12/03_finally_a_graph_i_can_understand.png){:width="1024"}
...
![Screenshot with an example of another nonsense graph](/assets/img/2017/12/04_why.png){:width="300"}
...
![Two screenshots of Joel's blog. One with a Husky, another one with a meaningless diagram](/assets/img/2017/12/joelspost.png){:width="3588"}
